...
export const Comment = () => {
    ...
    const { register, handleSubmit, formState: {errors}, getValues, reset } = useForm<FormValue>({
        mode: 'onSubmit'
    });
    ...
    return(
        <Container>
            ...
            <ShowComment>
                {visibleItems.map((item) => (<CommentItem key={item.id} id={item.id} comment={item.comment} userName={item.userName}></CommentItem>))}
                <div>
